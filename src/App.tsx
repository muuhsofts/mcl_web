...
import AddBenefit from './pages/benefities/AddBenefit';
...
import AboutMwananchi from './pages/about/AboutMwananchi';
...
// ========== NEW PUBLIC PAGE IMPORTS ==========
import AboutFTSection from "./pages/AboutFTSection";       
    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/about" element={<AboutFTSection />} />
          <Route path="/vision-mission" element={<VisionMissionPage />} />
          <Route path="/our-values" element={<OurValuesPage />} />

          {/* Public company layouts (static pages) */}
          ...
          <Route element={<AppLayout />}>
            ...
            {/* Admin About management (was /about, now /admin/about to avoid conflict with public /about) */}
            <Route
              path="/admin/about"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/mcl-groups/edit/:mcl_groupId"
              element={
                <ProtectedRoute>
                  <EditMCLgroup />
                </ProtectedRoute>
