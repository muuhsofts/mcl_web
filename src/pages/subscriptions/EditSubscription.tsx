...
const EditSubscription: React.FC = () => {
    ...
    const fetchSubscription = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          // DISPLAY EXACTLY AS STORED - NO CONVERSION
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // STORE EXACTLY AS TYPED - NO MODIFICATION
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className={`px-4 py-2 bg-blue-600 text-white rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 ${
