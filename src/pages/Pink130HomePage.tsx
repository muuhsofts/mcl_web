...
const Loader: React.FC = () => (
  ...
  >
    ...
    >
      Loading 130 Years of Pink...
    </motion.h2>
  </motion.div>
);

// --- Pink 130 Home Slideshow ---
const Pink130HomeSlideshow: React.FC<{ setLoaded: (isLoaded: boolean) => void }> = ({ setLoaded }) => {
...
// --- Pink 130 Section ---
const Pink130Section: React.FC<{ setLoaded: (isLoaded: boolean) => void }> = ({ setLoaded }) => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans flex flex-col">
      ...
      {!isLoading && (
        ...
        >
          <header>
            <Pink130HomeSlideshow setLoaded={setSlideshowLoaded} />
          </header>
          <main className="flex-grow">
            <Pink130Section setLoaded={setSectionLoaded} />
          </main>
          <footer>
            <Footer />
          </footer>
